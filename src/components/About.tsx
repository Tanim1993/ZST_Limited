...
export default function About() {
  ...
  return (
    <section id="about" class="py-24 bg-white dark:bg-[#0B0F1D] border-t border-slate-100 dark:border-slate-900/60 transition-colors duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div class="lg:col-span-6 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              ...
              {/* Mission Card */}
              <div class="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 space-y-3">
                <div class="w-9 h-9 rounded-lg bg-blue-100 dark:bg-blue-950 flex items-center justify-center text-blue-600 dark:text-blue-400">
                  <Target class="w-5 h-5" />
                </div>
                <h3 class="font-bold text-slate-900 dark:text-white text-base">Our Mission</h3>
              ...
              {/* Vision Card */}
              <div class="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 space-y-3">
                <div class="w-9 h-9 rounded-lg bg-emerald-100 dark:bg-emerald-950 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                  <Eye class="w-5 h-5" />
                </div>
                <h3 class="font-bold text-slate-900 dark:text-white text-base">Our Vision</h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
          ...
          <div class="lg:col-span-6 space-y-6">
            ...
            <div class="space-y-4 mb-2">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white block">
              ...
              {pillars.map((p, idx) => (
                ...
                >
                  <div class="flex items-start gap-4">
                    <div class="p-3 bg-white dark:bg-slate-800 rounded-xl shadow-sm tracking-tight text-center shrink-0">
                      {p.icon}
                    </div>
                    <div class="space-y-1">
                      <div class="flex items-center gap-2">
                        <h4 class="font-bold text-slate-900 dark:text-white text-sm md:text-base group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          {p.title}
                        </h4>
                        <span class="text-[9px] uppercase tracking-wider font-bold bg-slate-150 dark:bg-slate-800 text-slate-500 py-0.5 px-2 rounded-full">
                          {p.badge}
                        </span>
                      </div>
                      ...
                      <p class="text-xs text-slate-600 dark:text-slate-400 leading-normal pt-1.5">
                        {p.description}
                      </p>
                    </div>
                  </div>
